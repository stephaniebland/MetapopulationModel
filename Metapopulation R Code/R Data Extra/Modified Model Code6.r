...
l.p.a=islands.to.be.removed*num
...
nice.out.data<-rbind(nice.out.data,nice.tmp.out)
      prop.area.n[,alpha.count]=prop.area
      eigen.patch.rm.n[,alpha.count]=eigen.patch.rm
      eigen.islands.n[,alpha.count]=eigen.islands
      eigen.quality.n[,alpha.count]=eigen.quality
